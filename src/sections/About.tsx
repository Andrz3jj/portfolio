        ...
        <>
            <div className="relative flex items-center justify-center h-screen overflow-hidden">
                <div className="flex flex-col text-center">
                    ...
                    <span className="sm:text-md md:text-xl font-semibold pb-0.5 md:pb-0.5 flex items-center justify-center gap-2">Uczeń, programista. | Tarnobrzeg <GiPoland size={30} /></span>
