    ...
    return (
        <div className="flex justify-center pb-50">
            <Tabs defaultValue="work" className="w-full md:w-2/4 ml-6 mr-6 md:ml-0 md:mr-0">
                ...
                <TabsContent value="work" className="border shadow-md shadow-gray-100 p-7 border-gray-200 rounded-lg">
                    <Timeline experience={career} />
                </TabsContent>

                <TabsContent value="education" className="border shadow-md shadow-gray-100 p-7 border-gray-200 rounded-lg">
                    <Timeline experience={education} />
                </TabsContent>

                <TabsContent value="competitions" className="border shadow-md shadow-gray-100 p-7 border-gray-200 rounded-lg">
